...
export class ConservationComponent implements OnInit {
  ...
  data = [
          ...
          {header: "Philanthropic", subhead: "Ethical turtle races race organizers give back by making their races fundraisers for turtle conservation.", image: "./../../../assets/svg/014-give-money.svg", width: "50%"}
         ]
